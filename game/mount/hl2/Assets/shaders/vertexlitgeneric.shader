...
PS
{
    ...
    class ShadingModelSource
    {
            ...
            bool bLightWarp, bool bPhongWarp, float2 vUV )
        {
            ...
            {
                Light light = Light::From( vPositionWs, i.vPositionSs, idx );
            ...
            float3 vAmbient = AmbientLight::From( vPositionWs, i.vPositionSs, vAmbientNormal );
            ...
            {
                float flRimMultiply = flRimMask * flRimFresnel;
                float3 vAmbientRimColor = AmbientLight::From( vPositionWs, i.vPositionSs, vViewWs );
